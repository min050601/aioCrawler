...
class SpiderLog():
    def __init__(self,level_str='DEBUG',format='%(asctime)s %(filename)s[line:%(lineno)d] %(levelname)s %(message)s',datefmt='%a, %d %b %Y %H:%M:%S',filename=None,path=None,filemode='w',):
